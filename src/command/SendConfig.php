...
class SendConfig extends Command
{
    ...
    {
        //获取默认配置文件
        $content = file_get_contents(root_path() . 'vendor/yinxu46/aliyun-sms/src/config.php');

        $configPath = config_path() . '/';
        $configFile = $configPath . 'sms.php';
        ...
        $output->writeln('create sms config ok');
    }
